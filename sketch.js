...
var foodS         //?represents the local count of food?
var foodStock;    //represents the database leaf of Food
var btnAddFood;   //reprents the button addFood
var foodObj;
var database;
var feedTime; //Repersents database leaf of feed time
var feedS; //local var repersents feed Time
...
function setup() {
  ...
  foodStock.on("value",readStock,showError); //Q. Does '.on' read from the database?
  
  feedTime=database.ref('FeedTime');
  feedTime.on("value", readTime, showError);
